...
GOOS=linux GOARCH=mips64p32 go build
zip pingtunnel_mips64p32.zip pingtunnel

GOOS=linux GOARCH=mips64p32le go build
zip pingtunnel_mips64p32le.zip pingtunnel
